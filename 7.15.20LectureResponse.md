...
The ImgageDataGenerator() helps normalize the data, the pixel values so that they are between 0 and 1. The argument "rescale" gives the calculation for hwo we want the image to be rescaled ( for instance 1/255).
